...
SOURCE_REPORTS: tuple[SourceReportSpec, ...] = (
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch14-collection.json"),
        sha256="e796c08e6d8c0994c7378f978e315850dbb5c0b4aab2d029ce4bf196176a0773",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch15-collection.json"),
        sha256="d93cfc5fcc1ac9b29f59a07673c283afea18d4b806ab1b8e5d8bd5b576ad3420",
        schema_version="M2CS4V4Batch15CollectionAuditV1",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch16-collection.json"),
        sha256="d1fcaeadfcae9451394cad54b25b783e62942d50b5852a18e2317ccc015e9ee1",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch17-collection.json"),
        sha256="a279ddd178a82e99b24ada70d48389f5e83344bc21cd4e9a77d1b63dc333b217",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch18-collection.json"),
        sha256="a27116aa00f379f1ea461342b34ec8f7f621a8e916ca1f9eae0c63f86aa6d59b",
        schema_version="M2CS4V4Batch18CollectionAuditV1",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch21-collection.json"),
        sha256="53f9842a8679a44c876531764ea48456a5675475c9305383a2a17cfd3586e6c7",
        schema_version="M2CS4V4Batch21CollectionAuditV1",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch22-collection.json"),
        sha256="c8ca9c690468d41ba33d9eebe4d43de4a6336d5397be7ad51e3a07701a9626a6",
    ...
    SourceReportSpec(
        path=Path("reports/m2c-s4-v4-batch23-collection.json"),
        sha256="970177ff0932a24e7b2a92f45793bad55c46aa4d9ff95c62b8de263bb52a4cdc",
...
def build_report(*, project_root: Path) -> dict[str, Any]:
    ...
    for spec, report in parsed[:2]:
        for attempt in report["attempts"]:
            if str(attempt["classification"]).startswith("RAW_V3_"):
                ...
                complete_chain_count += 1
    for spec, batch_report in parsed[-15:]:
    ...
    complete_chain_count += 1
    if complete_chain_count != 49 or taxonomy != Counter(
        {
    ...
    return {
        ...
        "identity_audit": {
            ...
            "unique_v4_train_identities": 51,
            "unique_train_identities_total": 62,
        },
        "observed_yield": {
        ...
        "root_cause_finding": {
            ...
            "complete_v4_chains_with_steps_0_through_6_all_gates_pass": 38,
            "complete_chains_ending_in_contact_or_controller_rejection": 31,
            "complete_chains_ending_in_pregrasp_ik_rejection": 17,
        ...
        "blockers": [
            "ZERO_ELIGIBLE_TRAINING_EPISODES_ACROSS_62_UNIQUE_TRAIN_IDENTITIES",
            "ORIGINAL_V4_TRAIN_MANIFEST_EXHAUSTED_36_OF_36_KEYS_CONSUMED",
            "V4_EXTENSION1_MANIFEST_CONSUMED_15_OF_36_KEYS",
...
This report replays twenty-one immutable collection reports plus the governed offline replay of scene 19083. It does not collect, execute physics, train, run a model rollout, or perform formal Q-B evaluation.

## Measured yield

- Unique TRAIN identities: **{report["identity_audit"]["unique_train_identities_total"]}** (V3: 11; V4: 51)
- Complete eight-step physical chains: **{yield_data["complete_eight_step_chains"]}**
- Eligible and packaged training episodes: **0**
- Eligible yield per attempted identity: **0/62 = 0.0**
- Eligible yield conditional on a complete chain: **0/49 = 0.0**
...
All ten complete V3 chains and all thirty-eight newly collected Batch-09 through Batch-23 V4 chains passed gates for steps 0–6. The evidence supports a recurring terminal regrasp approach/contact-acceptance mismatch, but does not isolate perception offset, approach geometry, or object state as its cause. Scene 19083 passes the 32-detection offline schema replay but remains excluded by its unchanged physical failure; its replay also records a step-1 public-target-outside-K8 exclusion. The original frozen V4 TRAIN manifest is exhausted at 36/36 keys; the separately frozen extension manifest has consumed 15/36 keys.
