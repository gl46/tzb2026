...
- Parent evidence:
  - Q-A PASS: `reports/m2c-s2-exploration-v4.json` (V4 domain SHA-256
    `a08d0deec846168511ecdb8dac1ee54284493a973eb1d9a0e5fa843718196359`, manifest `4e78c044b68b11c1d871ecb90e65c7e2dfc616c8971abb89cb9969d2d48f738b`; B0 0/3 on pre-registered keys with
    unchanged probe `1e32fa89c8b1ef403a52f1b2c8326942b72092e6e88f50e8f780eff1c08c6094`; strict existence proof completed on seed
    9077 with 0 collision violations).
  - S3 PASS: `artifacts/m2c/dataset-v3.jsonl` SHA-256 `48924a208c0ab417384f09bbef45073a10f58c9aac16cc64089409288401f35b` (312/0,
    full class coverage), `artifacts/m2c/path-blocked-raw-v1.jsonl` SHA-256
    `704cc5790ca6c5f0694664195130585b7420660b6c99b29afc342b83ef5908d5` (raw evaluator evidence, no training label yet).
...
- `BIN_CELL_i` resolves to world-frame metres exclusively through
  ...
  (`scripts/generate_industrial_scenes.py`, SHA-256 `e9f9e20106a05dbec24453ce39422d57aa212709567fb7eba7f8d9beb03cd6c5`), i.e. the
...
- Schema, stale-track, frame/unit, IK, collision, controller, and safety
  ...
  and success definitions are untouched (probe `1e32fa89c8b1ef403a52f1b2c8326942b72092e6e88f50e8f780eff1c08c6094`).
