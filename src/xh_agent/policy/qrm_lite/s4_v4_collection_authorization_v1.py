...
BATCH22_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES = {
    **BATCH21_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES,
    "reports/m2c-s4-v4-batch21-collection.json": (
        "53f9842a8679a44c876531764ea48456a5675475c9305383a2a17cfd3586e6c7",
        "M2CS4V4Batch21CollectionAuditV1",
        3,
    ),
}
BATCH22_AUTHORITATIVE_PRIOR_ATTEMPT_KEY_COUNT = sum(
    expected_unique
    for _sha256, _schema, expected_unique in BATCH22_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES.values()
)
BATCH23_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES = {
    **BATCH22_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES,
    "reports/m2c-s4-v4-batch22-collection.json": (
        "c8ca9c690468d41ba33d9eebe4d43de4a6336d5397be7ad51e3a07701a9626a6",
        "M2CS4V4Batch22CollectionAuditV1",
        3,
    ),
}
BATCH23_AUTHORITATIVE_PRIOR_ATTEMPT_KEY_COUNT = sum(
    expected_unique
    for _sha256, _schema, expected_unique in BATCH23_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES.values()
)
BATCH24_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES = {
    **BATCH23_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES,
    "reports/m2c-s4-v4-batch23-collection.json": (
        "970177ff0932a24e7b2a92f45793bad55c46aa4d9ff95c62b8de263bb52a4cdc",
        "M2CS4V4Batch23CollectionAuditV1",
        3,
    ),
}
BATCH24_AUTHORITATIVE_PRIOR_ATTEMPT_KEY_COUNT = sum(
    expected_unique
    for _sha256, _schema, expected_unique in BATCH24_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES.values()
)
AUTHORITATIVE_PRIOR_ATTEMPT_PROFILES = {
    ...
    "m2c-s4-v4-train-batch-22": (
        BATCH22_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES,
        BATCH22_AUTHORITATIVE_PRIOR_ATTEMPT_KEY_COUNT,
    ),
    "m2c-s4-v4-train-batch-23": (
        BATCH23_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES,
        BATCH23_AUTHORITATIVE_PRIOR_ATTEMPT_KEY_COUNT,
    ),
    "m2c-s4-v4-train-batch-24": (
        BATCH24_AUTHORITATIVE_PRIOR_ATTEMPT_SOURCES,
        BATCH24_AUTHORITATIVE_PRIOR_ATTEMPT_KEY_COUNT,
    ),
}
