...
from .wrong_object import plan_wrong_object
from xh_agent.task_compiler.base import RecoveryPlanV1


def recovery_for(failure_type: str) -> RecoveryPlanV1:
    planners = {
        "EMPTY_GRASP": plan_empty_grasp,
        "WRONG_OBJECT": plan_wrong_object,
        "UNSTABLE_OR_WRONG_PLACEMENT": plan_placement,
        "RELEASE_FAILURE": plan_release,
    }
