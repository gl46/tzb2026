...
def test_yield_audit_replays_twenty_five_unique_keys_and_zero_eligible() -> None:
    ...
    assert report["observed_yield"]["complete_eight_step_chains"] == 17
...
def test_markdown_does_not_claim_measured_model_zero() -> None:
    ...
    assert "0/25 = 0.0" in markdown
    assert "0/17 = 0.0" in markdown
