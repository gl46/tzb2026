...
def test_yield_audit_replays_thirty_seven_unique_keys_and_zero_eligible() -> None:
    ...
    assert report["observed_yield"]["complete_eight_step_chains"] == 28
