...
def test_yield_audit_replays_all_fifty_six_unique_keys_and_zero_eligible() -> None:
    ...
    assert report["observed_yield"]["complete_eight_step_chains"] == 46
