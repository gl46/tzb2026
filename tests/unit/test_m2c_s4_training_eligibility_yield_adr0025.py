...
def test_yield_audit_replays_forty_unique_keys_and_zero_eligible() -> None:
    ...
    assert report["observed_yield"]["complete_eight_step_chains"] == 31
...
def test_markdown_does_not_claim_measured_model_zero() -> None:
    ...
    assert "0/40 = 0.0" in markdown
    assert "0/31 = 0.0" in markdown
