...
def test_yield_audit_replays_all_forty_seven_unique_keys_and_zero_eligible() -> None:
    ...
    assert report["observed_yield"]["complete_eight_step_chains"] == 38
...
def test_markdown_does_not_claim_measured_model_zero() -> None:
    ...
    assert "0/38 = 0.0" in markdown
    assert "36/36 keys are consumed" in markdown
